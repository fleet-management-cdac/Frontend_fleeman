    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-8">
            ...
            <div className="flex justify-between mb-6 text-xs text-gray-500">
                <span className={step >= 1 ? 'text-blue-600 font-medium' : ''}>Review</span>
                <span className={step >= 2 ? 'text-blue-600 font-medium' : ''}>Addons</span>
                ...
                <Card className="p-6">
                    ...
                    <div className="space-y-4 mb-8">
                        <div className="flex justify-between py-3 border-b">
                            ...
                            <span className="font-medium">{pickupDate ? new Date(pickupDate).toLocaleString() : '-'}</span>
                        </div>
                        <div className="flex justify-between py-3 border-b">
                            <span className="text-gray-500">Return Date</span>
                            <span className="font-medium">{returnDate ? new Date(returnDate).toLocaleString() : '-'}</span>
                        </div>
                        <div className="flex justify-between py-3 border-b">
                    ...
                    {selectedAddonId && (
                        <div className="bg-blue-50 rounded-lg p-4 mb-6">
                            <div className="flex justify-between items-center">
                                <span className="text-blue-700">Selected Addon:</span>
                                <span className="font-bold text-blue-800">
                                    {getSelectedAddon()?.addonName || getSelectedAddon()?.name}
                                </span>
                            </div>
                        </div>
                    )}
